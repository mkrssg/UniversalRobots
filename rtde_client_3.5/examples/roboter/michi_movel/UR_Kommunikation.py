...
a = 1.0
v = 0.8
qStart = np.array([np.deg2rad(0),np.deg2rad(-90),np.deg2rad(90),np.deg2rad(-90),np.deg2rad(-90),np.deg2rad(0)])
qTarget = np.array([np.deg2rad(90),np.deg2rad(-60),np.deg2rad(30),np.deg2rad(-90),np.deg2rad(-90),np.deg2rad(0)])
...
t = 10
qStart = np.array([np.deg2rad(0),np.deg2rad(-90),np.deg2rad(90),np.deg2rad(-90),np.deg2rad(-90),np.deg2rad(0)])
qTarget = np.array([np.deg2rad(90),np.deg2rad(-30),np.deg2rad(60),np.deg2rad(-90),np.deg2rad(-90),np.deg2rad(0)])
